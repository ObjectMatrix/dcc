...
<img width="826" height="495" alt="ui-ux" src="https://github.com/user-attachments/assets/7f56a208-fed1-4c35-a499-210901b6fe91" />

# APPENDIX  
```# DCC-200: WiFi-Controlled LED Panel
# MicroPython | Thonny | ESP32
# Web server runs on port 23
# Supports: single LED (GPIO) and NeoPixel RGB strip
...
# ─────────────────────────────────────────
WIFI_SSID     = "FBIHQ"
WIFI_PASSWORD = "nupsidupsi1204"
PORT          = 8080

LED_PIN       = 23       # Onboard or single LED GPIO pin
