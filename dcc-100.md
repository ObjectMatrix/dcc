...
<img width="5693" height="3564" alt="pwm-oscilloscope-view" src="https://github.com/user-attachments/assets/676afdf0-d64f-495e-96ec-d4013b22ee2d" />  
...
1. Motors don't have a volume knob -- PWM is it

You can't "partially" turn on a DC motor with analog voltage easily. PWM lets you send full 3.3V or 5V pulses but control how long they last. A motor receiving 50% duty cycle runs at roughly half speed. Every robot that moves uses this.
...
# Project 2: SOS Morse Code Signal 🆘
...
# Project 3: Project: Distance Alarm (homework)
